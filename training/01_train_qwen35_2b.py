"""
Training script: Qwen3.5-2B — Medical Chatbot Fine-tuning
QLoRA 4-bit, LoRA r=16, 3 epochs — GPU sewa (A100/H100 class)

Run:
  python training/01_train_qwen35_2b.py

Output:
  outputs/checkpoints/qwen35-2b-medical/   <- LoRA adapter
"""
...
CHECKPOINT_DIR = str(ROOT / "outputs" / "checkpoints" / "qwen35-2b-medical")
