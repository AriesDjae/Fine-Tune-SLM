"""
Training script: Gemma3-4B-IT — Medical Chatbot Fine-tuning
QLoRA 4-bit, LoRA r=16, 3 epochs — GPU sewa (A100/H100 class)

Run:
  python training/03_train_gemma3_4b.py

Output:
  outputs/checkpoints/gemma3-4b-medical/   <- LoRA adapter
"""
...
CHECKPOINT_DIR = str(ROOT / "outputs" / "checkpoints" / "gemma3-4b-medical")
